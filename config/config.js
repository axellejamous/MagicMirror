...
var config = {
	...
	modules: [
		...
		},
		{
			...
			config: {
				alarms: [
					{time: "07:00", days: [0,1,2,3,4,5,6], sound: "alarm.mp3", title: "School", message: "Get ready for school!!"},
					{time: "19:20", days: [0,1,2,3,4,5,6], sound: "alarm.mp3", title: "Alarm", message: "Wake up!"},
				],		
			}
		},
		{
